...
if (!$UserInstall -and !$isAdmin) {
    ...
    Write-Output "  2. Execute: .\win_install.ps1"
    Write-Output ""
...
Write-Success "Created $installDir\uninstall.ps1"
...
Set-Content -Path "$installDir\rebuild.ps1" -Value $rebuildScript -Encoding UTF8
Write-Success "Created $installDir\rebuild.ps1"
...
Write-Output "  ssp --show-code -A   - Show code and analysis"
Write-Output "  ssp --help           - Show all options"
Write-Output ""
Write-ColorOutput Cyan "Helper Scripts Created:"
Write-Output "  $installDir\uninstall.ps1"
Write-Output "  $installDir\rebuild.ps1"
Write-Output ""
